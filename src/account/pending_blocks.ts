 ...
 * ```
 */
export const get_pending_blocks = async (account: string, rpc_node_url: RPC_Node_URL | string = RPC_Node_URL.NANOS) => (await axiod.post<Blocks>(rpc_node_url, { action: "pending", account })).data;