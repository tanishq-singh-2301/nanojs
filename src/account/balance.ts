 ...
 * ```
 */
export const get_account_balance = async (account: string, rpc_node_url: RPC_Node_URL | string = RPC_Node_URL.NANOS) => (await axiod.post<Account_Balance>(rpc_node_url, { action: "account_balance", account })).data;