 ...
 * ```
 */
export const get_account_info = async (account: string, rpc_node_url: RPC_Node_URL | string = RPC_Node_URL.NANOS) => (await axiod.post<Account_Info>(rpc_node_url, { action: "account_info", account })).data;