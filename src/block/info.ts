 ...
 * ```
 */
export const get_block_info = async (hash: string, rpc_node_url: RPC_Node_URL | string = RPC_Node_URL.NANOS) => (await axiod.post<Block_Info>(rpc_node_url, { action: "block_info", hash })).data
