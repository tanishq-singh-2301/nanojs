 ...
 * ```
 */
export const publish_block = async (block: BlockRepresentation, rpc_node_url: RPC_Node_URL | string = RPC_Node_URL.NANOS) => (await axiod.post<Publish_Block>(rpc_node_url, { action: "process", json_block: 'true', block })).data;
