...
Deno.test("Correct hash", async () => {
    const { error, hash } = await work_generate(fake_wallet.accounts[2].public_key);
    
    assertEquals(error, undefined);
    assertEquals(hash, "F15B16CAEA79AC090CA6E4987535C6E05E9228BC662FEDCB6315F3432AF227B0")
})